...
movie.to_csv('movie_list_result_noh.csv', index=False, header=False)


# Reader 객체 생성
from surprise import Reader
reader = Reader(line_format='movieCd userid score', sep=',', rating_scale=(0.5, 5))
data = Dataset.load_from_file('movie_list_result_noh.csv', reader=reader)
data
...
data = Dataset.load_from_df(reader[['userid', 'score', 'movieCd']], reader)  #####
