...
# movies.replace({'Action' : {1, 'Action'}}, {'Adventure' : {1, 'Adventure'}}, {'Adventure' : {1, 'Adventure'}}, {'Children\'s' : {1, 'Children\'s'}}, {'Comedy' : {1, 'Comedy'}}, {'Crime' : {1, 'Crime'}},\
#                {'Documentary' : {1, 'Documentary'}}, {'Drama' : {1, 'Drama'}}, {'Fantasy' : {1, 'Fantasy'}}, {'Film-Noir' : {1, 'Film-Noir'}}, {'Action' : {1, 'Horror'}}, {'Musical' : {1, 'Musical'}}, \
#                {'Romance' : {1, 'Romance'}}, {'Sci-Fi' : {1, 'Sci-Fi'}}, {'Thriller' : {1, 'Thriller'}}, {'War' : {1, 'War'}}, {'Western' : {1, 'Western'}})
# movies.replace({'Action' : 0, 'Action' : 0, 'Adventure' : 0, 'Animation' : 0, 'Children\'s' : 0, 'Comedy' : 0, 'Crime' : 0, 'Documentary' : 0, 'Drama' : 0, 'Fantasy' : 0, \
#                 'Film-Noir' : 0, 'Horror' : 0, 'Mystery' : 0, 'Romance' : 0, 'Sci-Fi' : 0, 'Thriller' : 0, 'War' : 0 , 'Western' : 0}, '')
# movies.head()
...
rating_matrix = ratings_train.pivot(index='userId', columns='movieId', values='rating')
