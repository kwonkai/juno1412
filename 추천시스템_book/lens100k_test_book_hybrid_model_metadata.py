...
matrix_dummy = rating_matrix.copy().fillna(0).drop(columns={0}, axis=1)
user_similarity = cosine_similarity(matrix_dummy, matrix_dummy)
user_similarityuser_similarity = pd.DataFrame(user_similarity, index=rating_matrix.index, columns=rating_matrix.index)
